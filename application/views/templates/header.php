...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      <a class="navbar-brand" style="color:#666" href="<?= site_url("home/dashboard") ?>">UNIVERSITAS PROGRAMMER</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          <li class="nav-item me-2 <?php if ($this->uri->segment(3, NULL) == NULL || $this->uri->segment(3, NULL) == 'dosen') echo 'currentPage' ?>">
            <a class="nav-link" href="<?= site_url("home/dashboard/dosen") ?>">Dosen</a>
          </li>
          <li class="nav-item me-2 <?php if ($this->uri->segment(3, NULL) == 'mahasiswa') echo 'currentPage' ?>">
            <a class="nav-link" href="<?= site_url("home/dashboard/mahasiswa") ?>">Mahasiswa</a>
          </li>
          <li class="nav-item">
