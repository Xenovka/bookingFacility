      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          <li class="nav-item me-2 <?php if ($this->uri->segment(2, NULL) == 'facilities') echo 'currentPage' ?>">
            <a class="nav-link" href="<?= site_url("user") ?>">Facilities</a>
          </li>
          <li class="nav-item me-2 <?php if ($this->uri->segment(2, NULL) == 'reserved') echo 'currentPage' ?>">
            <a class="nav-link" href="<?= site_url("user/reserved") ?>">Requests</a>
          </li>
